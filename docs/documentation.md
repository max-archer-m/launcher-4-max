...
| 1.4.0 completed delivery | [`docs/delivery/1.4.0/delivery.md`](delivery/1.4.0/delivery.md) | [`docs/delivery/1.4.0/delivery.zh-CN.md`](delivery/1.4.0/delivery.zh-CN.md) | Delivery records | Records the ordered favorite-module Home loop and version closure through Iterations 22-25 |
| 1.5.0 completed delivery | [`docs/delivery/1.5.0/delivery.md`](delivery/1.5.0/delivery.md) | [`docs/delivery/1.5.0/delivery.zh-CN.md`](delivery/1.5.0/delivery.zh-CN.md) | Delivery records | Records Drawer search, ordinary navigation, display settings, and version closure through Iterations 26-28 |
| 1.6.0 completed delivery | [`docs/delivery/1.6.0/delivery.md`](delivery/1.6.0/delivery.md) | [`docs/delivery/1.6.0/delivery.zh-CN.md`](delivery/1.6.0/delivery.zh-CN.md) | Delivery records | Records the Settings local backup and restore journey, Drawer drag-to-favorite, and the edit-dock and Drawer-background reworks through Iterations 29-31 |
| 1.7.0 planned delivery | [`docs/delivery/1.7.0/delivery.md`](delivery/1.7.0/delivery.md) | [`docs/delivery/1.7.0/delivery.zh-CN.md`](delivery/1.7.0/delivery.zh-CN.md) | Delivery records | Plans the configurable Home quick actions with the bound screen lock, the default-launcher prompt, the tapering sliders, and public release preparation through Iterations 32-34 |
